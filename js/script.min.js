!(function (l) {
  ...
  l(".bg_image_holder").each(function () {
    ...
    e.css({ "background-image": "url(" + s + ")", opacity: "1" })
      .children()
      .attr("alt", s);
  }),
    e < 992 &&
    ...
    l(".testimonial-carousel-two").owlCarousel({
      ...
      responsive: { 0: { items: 1 }, 768: { items: 2 }, 1e3: { items: 2 } },
    }),
  ...
  l(".pcount").on("click", function () {
    ...
    l(".give_rating").barrating({ theme: "fontawesome-stars" }),
  ...
  l(window).on("scroll", function () {
    ...
    i.on("click", function () {
      return l("html, body").animate({ scrollTop: 0 }, 800), !1;
    }),
...
!(function () {
  ...
  function e(e, t, l, r) {
    var s = new google.maps.LatLng(t, l),
      ...
      f = new google.maps.Marker({ position: s, icon: "img/mpc.png" });
    new google.maps.InfoWindow({ content: "united-states" });
    f.setMap(y);
  }
  $(".map").length &&
      ...
      $("#map2").length &&
        e("map2", 50.797897, -1.077641, [
          ...
          },
          {
            featureType: "landscape",
            elementType: "geometry",
            stylers: [{ color: "#dce1dc" }, { lightness: 20 }],
          },
          {
            featureType: "poi",
            elementType: "geometry",
          ...
          },
          {
            featureType: "road.local",
            elementType: "geometry",
            stylers: [{ color: "#dadada" }, { lightness: 16 }],
          },
          {
            featureType: "transit",
            elementType: "geometry",
          ...
          },
          {
            featureType: "water",
            elementType: "geometry",
            stylers: [{ color: "#d1d1d1" }, { lightness: 17 }],
          },
        ]);
      $("#map3").length &&
...
!(function (e) {
  ...
  $(".hero-slider").owlCarousel({
    ...
    smartSpeed: 900,
    items: 1,
    navText: ['<span class="fs-3">←</span>', '<span class="fs-3">→</span>'],
    responsive: {
      0: { nav: false },
      768: { nav: true },
    },
